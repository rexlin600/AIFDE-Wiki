...
- [AIFDE Wiki 项目档案](PRJ-AIFDE-Wiki.md)：以本 Wiki 自身示范公开知识产品的边界、架构和质量门禁。

## 路线连接

- [AI/FDE 七阶段路线](../01-Roadmap/Roadmap-MOC.md)定义各阶段项目增量。
- [FDE 综合项目](../01-Roadmap/Phase-6-FDE-Capstone.md)定义最终证据包。
- [FDE 能力模型](../00-Guide/FDE-Competency-Model.md)用于判断证据对应的能力维度和深度。
- [开源研究](../13-Open-Source/Open-Source-MOC.md)补充依赖选择、调用链和最小复刻证据。
