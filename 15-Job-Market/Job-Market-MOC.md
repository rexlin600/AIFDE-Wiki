...
- [OpenAI：Forward Deployed Engineer, Healthcare](Job-OpenAI-FDE-Healthcare-20260909.md)，官方页面访问于 2026-09-09。

## 与路线的连接

季度汇总用于调整[路线总览](../01-Roadmap/Roadmap-MOC.md)的证据优先级，并以 [FDE 能力模型](../00-Guide/FDE-Competency-Model.md)聚类；单个岗位不能决定完整学习路线，也不用于推断公司的内部职级标准。
