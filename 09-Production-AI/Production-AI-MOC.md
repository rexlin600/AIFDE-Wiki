...
- 至少一个可运行的 [RAG](../06-RAG/RAG-MOC.md) 或 [Agent](../07-Agent/Agent-MOC.md) 项目及固定评测集。
- HTTP 服务、异步任务、队列、容器、指标、日志、Trace 与 CI/CD 基础。
- [安全治理](../10-AI-Safety-Governance/AI-Safety-Governance-MOC.md)中的最小权限、秘密与审计要求。
...
- 以[阶段 5：生产 AI](../01-Roadmap/Phase-5-Production-AI.md)的退出证据完成加固。
...
- [RAG](../06-RAG/RAG-MOC.md)、[Agent](../07-Agent/Agent-MOC.md)和[多模态 AI](../08-Multimodal-AI/Multimodal-AI-MOC.md)：提供被生产化的应用链路。
- [安全治理](../10-AI-Safety-Governance/AI-Safety-Governance-MOC.md)：提供发布与运行的安全门禁。
- [FDE 实践](../11-FDE-Practice/FDE-Practice-MOC.md)：把 SLO、Runbook 与运行证据纳入客户验收。
