...
- [LLM](../05-LLM/LLM-MOC.md)中的结构化输出、Function Calling、上下文和模型选型。
- [RAG](../06-RAG/RAG-MOC.md)中的证据检索、引用、权限与失败分类。
...
- 以[阶段 4：Agent 工程](../01-Roadmap/Phase-4-Agent-Engineering.md)的退出证据约束可靠性与答辩。
...
- [RAG](../06-RAG/RAG-MOC.md)：为 Agent 提供受权限约束的外部证据。
- [生产 AI](../09-Production-AI/Production-AI-MOC.md)：提供网关、可观测性、部署和容量控制。
- [安全治理](../10-AI-Safety-Governance/AI-Safety-Governance-MOC.md)：限定工具、数据和多 Agent 的信任边界。
- [FDE 实践](../11-FDE-Practice/FDE-Practice-MOC.md)：把 Agent 设计嵌入真实客户流程与验收指标。
