...
创建笔记时复制对应模板：[MOC](../Z-模板/Template-MOC.md)、[Concept](../Z-模板/Template-Concept.md)、[Pattern](../Z-模板/Template-Pattern.md)、[Experiment](../Z-模板/Template-Experiment.md)、[Project](../Z-模板/Template-Project.md)、[Source](../Z-模板/Template-Source.md)、[Interview](../Z-模板/Template-Interview.md)、[Decision](../Z-模板/Template-Decision.md) 或 [Retrospective](../Z-模板/Template-Retrospective.md)。提交前须将模板变量替换为真实值，并删除无意义的空属性。
