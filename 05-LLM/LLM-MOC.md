...
- [深度学习](../04-Deep-Learning/Deep-Learning-MOC.md)中的 Attention、Transformer、优化与 PyTorch 工程。
- [机器学习](../03-Machine-Learning/Machine-Learning-MOC.md)中的数据拆分、泛化、指标和错误分析。
...
- 以[阶段 2：LLM 工程](../01-Roadmap/Phase-2-LLM-Engineering.md)的退出证据约束复现、适配和模型选择。
...
- [深度学习](../04-Deep-Learning/Deep-Learning-MOC.md)：提供 Transformer、训练与推理机制。
- [机器学习](../03-Machine-Learning/Machine-Learning-MOC.md)：提供评测、泛化和错误分析方法。
- [AI 全局知识地图](../00-Guide/AI-Knowledge-Map.md)：查看 LLM 与 RAG、Agent、生产和安全的依赖关系。
- [AI/FDE 七阶段路线](../01-Roadmap/Roadmap-MOC.md)：把领域知识落实为阶段实验与项目证据。
