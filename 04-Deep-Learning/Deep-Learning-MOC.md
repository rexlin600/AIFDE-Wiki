...
- [数学与 AI 基础](../02-AI-Foundations/AI-Foundations-MOC.md)中的矩阵、梯度、链式法则、优化和数值稳定性。
- [机器学习](../03-Machine-Learning/Machine-Learning-MOC.md)中的数据拆分、泛化、指标和泄漏。
- Python 类、迭代器和数组编程基础。
...
- 把 Attention 与 Transformer 最小复刻作为[阶段 2：LLM 工程](../01-Roadmap/Phase-2-LLM-Engineering.md)的机制证据。
...
- [数学与 AI 基础](../02-AI-Foundations/AI-Foundations-MOC.md)：解释梯度、优化和数值误差。
- [机器学习](../03-Machine-Learning/Machine-Learning-MOC.md)：提供泛化、验证和指标方法。
- [LLM](../05-LLM/LLM-MOC.md)：将 Transformer 扩展到预训练、适配和生成。
- [AI 全局知识地图](../00-Guide/AI-Knowledge-Map.md)：查看深度学习的上下游位置。
